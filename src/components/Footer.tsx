      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4 max-w-xs">
              Dedicated to providing support, awareness, and resources for cancer patients and their families in the Tibetan community.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">123 Main Street, Dharamshala, Himachal Pradesh, India</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-muted-foreground">info@tibetancancersociety.org</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-center text-muted-foreground text-sm">
            © {new Date().getFullYear()} Tibetan Cancer Society. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
